...
*Table of Contents*
:CONTENTS:
- [[#lepton-old-name-proton-fix---photon-stlyed][Lepton - Photon Stlyed]]
...
** Introduction
  ...
  | *Wiki*      |                               |      | |
  | [[https://github.com/KinoHermes0/Lepton/wiki/Installation-Guide][Installation Guide]] | [[https://github.com/KinoHermes0/Lepton/wiki/Screenshots][Screenshots]] | [[https://github.com/KinoHermes0/Lepton/wiki/Compatibility-Issues-Solution][Compatibility Issues Solution]] | [[https://github.com/KinoHermes0/Lepton/wiki/Tips][Tips]] |
...
** Installation Guide
   ...
   *Script Installation (experimental)*
   ...
   Linux, mac users:
   #+BEGIN_SRC bash
   bash -c "$(curl -fsSL https://raw.githubusercontent.com/KinoHermes0/Lepton/photon-style/install.sh)"
   #+END_SRC

   Windows users: Run powershell as administrator
   #+BEGIN_SRC powershell
   Powershell -c "Set-ExecutionPolicy Bypass -Scope Process -Force; [System.Net.ServicePointManager]::SecurityProtocol = [System.Net.ServicePointManager]::SecurityProtocol -bor 3072; iwr https://raw.githubusercontent.com/KinoHermes0/Lepton/photon-style/install.ps1 -useb | iex"
   #+END_SRC

   *Manual Installation*

   You can see the [[https://github.com/KinoHermes0/Lepton/wiki/Installation-Guide][installation guide]] with screenshots on the wiki.
