This is my personal fork, for the original go [[https://github.com/black7375/Firefox-UI-Fix][here]].
...
*Table of Contents*
:CONTENTS:
- [[#lepton-old-name-proton-fix][Lepton]]
...
** Installation Guide
   ...
   *Script Installation (experimental)*
   ...
   Linux, mac users:
   #+BEGIN_SRC bash
   bash -c "$(curl -fsSL https://raw.githubusercontent.com/KinoHermes0/Lepton/master/install.sh)"
   #+END_SRC
  ...
  If you prefer Photon, see [[https://github.com/KinoHermes0/Lepton/tree/photon-style][Lepton's photon-style]].\\
  If you prefer Proton, see [[https://github.com/KinoHermes0/Lepton/tree/proton-style][Lepton's proton-style]].
